...
void MioSkim_2L(TString fs, TString year, bool max_entry, int set_low, int set_max, TString run, TString subnameIn, TString subnameOut, TString resonance){
...
// 
  ...
  TString infilename;
  TString nome_file;
  infilename = "/cmsuf/data/store/user/t2/users/ferrico/SingleBS_studies/After/";
  if(run == "no"){
  	infilename = infilename + "DY_" + year + "_" + subnameIn + ".root";  
  	nome_file =  "./DY_" + year + "_" + subnameOut + "_cancella.root";	
  }
  else{
  	infilename = infilename + DataSetType.at(0) + "_Run" + year + run + ".root";
