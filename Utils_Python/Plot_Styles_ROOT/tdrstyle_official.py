...
# Margins (controls the space between the axes and the edge of canvas):
  ...
  tdrStyle.SetPadLeftMargin(0.10)  #0.16
  tdrStyle.SetPadRightMargin(0.10)  #0.05, 0.02
...
# For the axis titles:
  ...
  tdrStyle.SetTitleXOffset(1.1)  # 1.0, 0.9
  tdrStyle.SetTitleYOffset(1.3)  # 1.0, 1.10, 1.25
