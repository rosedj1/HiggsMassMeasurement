...
inpath_sigmadict = f"/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/ApplyCorr/MC2016DY2mu/MC2016DY_finalmuoncoll_allitergaussfitsonKB2DsandKB3Ds_redo.pdf"
...
if __name__ == "__main__":
    ...
    mu_coll = open_pkl(inpath_sigmadict)
