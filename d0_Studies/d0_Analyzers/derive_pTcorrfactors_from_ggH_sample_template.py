...
outpdf_dir = f"/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/Plots/derivepTcorrplots/ggH_m4mu_2017/"
...
outfile_prefix = f"MC2017_ggH_dpTOverpT_fullstats"
...
pT_ls = [5.0, 10.0, 14.0, 20.0, 27.0, 38.0, 50.0, 75.0, 100.0, 1000.0]
