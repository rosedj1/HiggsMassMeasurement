...
outpdf_dir = f"/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/Plots/derivepTcorrplots/ggF_m4mu/deleteme/"
# outpkl_dir     = f"/blue/avery/rosedj1/HiggsMassMeasurement/d0_Studies/KinBin_Info/"  #MuonPickles/
outpkl_dir = f"/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/Pickles/deleteme/"
outfile_prefix = f"MC2018_ggH_dpTOverpT_fullstats_rerunendcap"

# eta_ls = equal_entry_bin_edges_eta_mod1_wholenum[1:3]
...
def prep_files(eta_ls, pT_ls, 
    ...
    for file_ in [outpdf_path, outpkl_path, outpkl_pT_corr_path]:
        check_overwrite(file_, overwrite)
...
def main():
    ...
    printer.make_plots_pretty(gridOn=True, show_plots=show_plots_to_screen)
    # Begin analysis.
