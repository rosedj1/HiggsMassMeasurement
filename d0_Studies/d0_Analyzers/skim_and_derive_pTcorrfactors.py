...
outdir_pdf = "/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/plots/derivepTcorrplots/DY2016/test/"
# outdir_pkl     = f"/blue/avery/rosedj1/HiggsMassMeasurement/d0_Studies/KinBin_Info/"  #MuonPickles/
outdir_pkl = "/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/pickles/2016/DY/test/"
outfile_prefix = "MC2016DY_manystats_test05"
...
max_n_evts = 2E6
print_out_every = 5E5
regions = 5       # Number of equal-entry regions along qd0 axis.
iters = 3
...
def main():
    ...
    if do_binned_analysis:
        mu_coll.do_3D_iter_gaus_fits(binned_fit=False, bins_dpTOverpT=bins_dpTOverpT, bins_qd0=bins_qd0, 
    ...
    # all_plots = mu_coll.hist_inclusive_ls + mu_coll.get_all_kb2d_plots("dpT/pT hists", "qd0 hists") + mu_coll.get_all_kb3d_plots("dpT/pT iterfit", "qd0 hists")
