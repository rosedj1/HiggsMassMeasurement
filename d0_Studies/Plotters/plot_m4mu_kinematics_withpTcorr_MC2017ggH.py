...
suffix = "fullstats"
year = "2017"
infileroot_path = "/cmsuf/data/store/user/t2/users/ferrico/Full_RunII/Production_10_2_18/Higgs_VX_BS/125/GluGluHToZZTo4L_M125_2017.root"
inpkl_pT_corr_factor_dict = "/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/Pickles/2017/ggH_m4mu/BestSoFar/combined_pT_corr_factor_dct_derivedfromMC2017ggH.pkl"
# inpkl_pT_corr_factor_dict = "/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/Pickles/2018/ggH_m4mu/BestSoFar/combined_pT_corr_factor_dct_derivedfromMC2018ggH.pkl"
...
outpath_rootfile = f"/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/rootfiles/ggH_skimmed/MC{year}_m4mu_m4mucorr_vals_{suffix}.root"
outpath_pdf      = f"/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/Plots/applypTcorrplots/CorrFromMCggH/MC{year}_dpTOverpTdist_beforeafterpTcorr_{suffix}.pdf"
outpath_pkl      = f"/cmsuf/data/store/user/t2/users/rosedj1/HiggsMassMeasurement/d0_studies/Pickles/2017/ggH_m4mu/BestSoFar/afterapplycorr_kb2d_dict_{suffix}.pkl"
