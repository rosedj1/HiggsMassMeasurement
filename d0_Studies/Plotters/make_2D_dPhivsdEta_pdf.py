...
eta_bin_edges = [2.10, 2.20, 2.30, 2.40]  # endcap
...
delta_eta_bin_limits = delta_phi_bin_limits = [-0.01, 0.01, 0.0001]

outpath = "/Users/Jake/Desktop/20200427/2Dplots_dPhivsdEta/"
pdf_name_base = "endcap_scan"  # Does not need filler underscores.
...
for k in range(len(eta_bin_edges)-1):
    ...
    with PdfPages(outfile) as pdf:
        for kbinned in kbin_ls:
            kbinned.make_2D_plot(x_kinem="delta_eta", y_kinem="delta_phi", 
                                 x_bin_limits=delta_eta_bin_limits, y_bin_limits=delta_phi_bin_limits,
