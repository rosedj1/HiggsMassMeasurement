...
#----- User Parameters -----#
inpath_file = "/cmsuf/data/store/user/t2/users/ferrico/Full_RunII/Production_10_2_18/Higgs_VX_BS/125/GluGluHToZZTo4L_M125_2017.root"
inpath_pkl = "/ufrc/avery/rosedj1/HiggsMassMeasurement/d0_Studies/KinBin_Info/d0_pT_corrfactors_0p0eta2p4__5p0pT1000p0.pkl"
outpath_file = "/ufrc/avery/rosedj1/HiggsMassMeasurement/d0_Studies/root_files/m4mu_withcorr_MC_2017_ggF_fullstats_pTlt200.root"
...
def check_muon_kinem(mu):
        ...
        if mu.Pt() > 200: print("HEY, HIGH PT MUON HERE!")  # Delete this later.
        return all([passed_eta, passed_pT])
...
print(f"Found {n_muons_bad_kinem} events with bad kinematics.")
outf.cd()
